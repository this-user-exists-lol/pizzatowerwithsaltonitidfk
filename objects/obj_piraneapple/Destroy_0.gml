if (ds_list_find_index(global.baddieroom, id) == -1)
{
    ...
    if (obj_player.state == (23 << 0) && obj_player.sprite_index != spr_player_suplexmash1 && obj_player.sprite_index != spr_player_suplexmash2 && obj_player.sprite_index != spr_player_suplexmash3 && obj_player.sprite_index != spr_player_suplexmash4)
    {
