...
if (grabbed == 1)
{
    ...
    if (playerid.state == (3 << 0) || playerid.state == (29 << 0) || playerid.state == (48 << 0) || playerid.state == (43 << 0) || playerid.state == (44 << 0) || playerid.state == (10 << 0))
    {
        thrown = 0
        grav = 0
        grounded = 0
        x = playerid.x
        if (playerid.sprite_index != spr_player_haulingstart && playerid.state != (3 << 0))
            y = (playerid.y - 60)
    ...
    with (playerid)
    {
        ...
        if (!((state == (3 << 0) || state == (48 << 0) || state == (29 << 0) || state == (43 << 0) || state == (44 << 0) || state == (10 << 0) || state == (49 << 0) || state == (45 << 0) || state == (50 << 0) || state == (51 << 0) || state == (52 << 0))))
        {
            other.grav = 0.5
            other.x = x
            other.y = y
    ...
    hsp = 0
    if (playerid.state == (3 << 0))
    {
        x = (playerid.x + (playerid.xscale * 50))
        y = playerid.y
    }
    if (playerid.state == (48 << 0) && playerid.sprite_index == playerid.spr_swingding)
    {
    ...
    if (playerid.state == (10 << 0))
    {
        x = (playerid.x + (playerid.xscale * 15))
        y = playerid.y
    }
    if (playerid.state == (45 << 0))
    {
