...
if (grabbed == 1)
{
    ...
    if (obj_player.state == (29 << 0) || obj_player.state == (48 << 0) || obj_player.state == (43 << 0) || obj_player.state == (44 << 0) || obj_player.state == (10 << 0))
    {
        grounded = 0
        x = obj_player.x
    ...
    with (obj_player)
    {
        ...
        if (!((state == (48 << 0) || state == (29 << 0) || state == (43 << 0) || state == (44 << 0) || state == (10 << 0) || state == (49 << 0) || state == (45 << 0) || state == (50 << 0) || state == (51 << 0) || state == (52 << 0))))
        {
            other.x = x
            other.y = y
            other.grabbed = 0
