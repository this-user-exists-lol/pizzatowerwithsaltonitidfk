...
if (global.combo >= 3 && state != (53 << 0) && global.coop == 1)
    supercharged = 1
...
if (global.coop == 1)
{
    if ((state == (49 << 0) || state == (23 << 0)) && (!((obj_player1.state == (49 << 0) || obj_player1.state == (23 << 0)))))
        fightballadvantage = 1
    else if (!((obj_player1.state == (49 << 0) || obj_player1.state == (23 << 0))))
...
if (key_start && global.coop == 1 && fightball == 0 && obj_player1.state != (93 << 0) && obj_player1.state != (113 << 0))
{
    ...
    with (obj_player1)
    {
        if (state == (48 << 0) || state == (45 << 0) || state == (10 << 0))
            state = (0 << 0)
    }
    scr_changetoppings()
}
...
if ((!instance_exists(baddiegrabbedID)) && (state == (48 << 0) || state == (45 << 0) || state == (10 << 0)))
    state = (0 << 0)
...
if (inv_frames == 0 && hurted == 0)
    image_alpha = 1
if (state == (72 << 0) || state == (10 << 0) || state == (46 << 0) || state == (25 << 0) || state == (16 << 0) || state == (13 << 0) || state == (19 << 0) || state == (26 << 0) || state == (28 << 0) || state == (36 << 0) || state == (42 << 0) || state == (36 << 0) || state == (39 << 0) || state == (93 << 0) || state == (76 << 0) || state == (65 << 0))
    attacking = 1
else
    attacking = 0
...
{
    if (state != (74 << 0) && sprite_index != spr_bombpepintro && state != (33 << 0) && sprite_index != spr_knightpepthunder && state != (2 << 0) && state != (6 << 0) && state != (68 << 0) && state != (16 << 0) && state != (41 << 0) && sprite_index != spr_player_crouchshoot && state != (67 << 0) && state != (35 << 0) && state != (39 << 0) && state != (75 << 0) && state != (70 << 0) && state != (69 << 0))
