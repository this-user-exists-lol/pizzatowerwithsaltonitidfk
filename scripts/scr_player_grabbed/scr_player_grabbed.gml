function scr_player_grabbed()
{
	switch object_index
	{
	    case obj_player2:
	        ...
	        if (obj_player1.state == (93 << 0) && fightball == 1)
	        {
	            x = obj_player1.x
	            y = obj_player1.y
	        }
	        ...
	        with (obj_player1)
	        {
	            ...
	            if (!((state == (48 << 0) || (state == (93 << 0) && fightball == 1) || state == (3 << 0) || state == (29 << 0) || state == (43 << 0) || state == (44 << 0) || state == (10 << 0) || state == (49 << 0) || state == (45 << 0) || state == (50 << 0) || state == (51 << 0) || state == (52 << 0))))
	            {
	                baddiegrabbedID = 149
	    ...
	    case 3:
	        ...
	        if (obj_player2.state == (93 << 0) && fightball == 1)
	        {
	            x = obj_player2.x
	            y = obj_player2.y
	        }
