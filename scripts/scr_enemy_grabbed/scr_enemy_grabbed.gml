function scr_enemy_grabbed()
{
	if (grabbedby == 1)
	{
	    ...
	    if (obj_player1.state == (29 << 0) || obj_player1.state == (48 << 0) || obj_player1.state == (43 << 0) || obj_player1.state == (44 << 0) || obj_player1.state == (10 << 0))
	    {
	        x = obj_player1.x
	    ...
	    with (obj_player1)
	    {
	        ...
	        if (!((state == (48 << 0) || state == (3 << 0) || state == (29 << 0) || state == (43 << 0) || state == (44 << 0) || state == (10 << 0) || state == (49 << 0) || state == (45 << 0) || state == (50 << 0) || state == (51 << 0) || state == (52 << 0))))
	        {
	            other.x = x
	            other.y = y
	            other.state = (109 << 0)
	    ...
	    if (obj_player1.state == (3 << 0) && obj_player1.image_index < 5)
	    {
	        x = (obj_player1.x + (obj_player1.xscale * 60))
	        y = obj_player1.y
	    }
	    if (obj_player1.state == (50 << 0))
	    {
	        alarm[3] = 3
	        global.hit += 1
	        if (other.object_index == obj_pizzaball)
	    ...
	    if (obj_player1.state == (10 << 0))
	    {
	        x = (obj_player1.x + (obj_player1.xscale * 15))
	        y = obj_player1.y
	    }
	    if (obj_player1.state == (45 << 0) && obj_player1.sprite_index == obj_player1.spr_piledriver)
	    {
	    ...
	    if (obj_player1.state == (48 << 0) && obj_player1.sprite_index == obj_player1.spr_swingding)
	    {
	        if (floor(obj_player1.image_index) == 0)
	        {
	            depth = -8
	...
	if (grabbedby == 2)
	{
	    ...
	    if (obj_player2.state == (29 << 0) || obj_player2.state == (48 << 0) || obj_player2.state == (43 << 0) || obj_player2.state == (44 << 0) || obj_player2.state == (10 << 0))
	    {
	        x = obj_player2.x
	    ...
	    if (obj_player2.state == (3 << 0) && obj_player2.image_index < 5)
	    {
	        x = (obj_player2.x + (obj_player2.xscale * 60))
	        y = obj_player2.y
	    }
	    if (obj_player2.state == (50 << 0))
	    {
	        alarm[3] = 3
	        global.hit += 1
	        if (other.object_index == obj_pizzaball)
	    ...
	    if (obj_player2.state == (10 << 0))
	    {
	        x = (obj_player2.x + (obj_player2.xscale * 15))
	        y = obj_player2.y
	    }
	    if (obj_player2.state == (45 << 0) && obj_player2.sprite_index == obj_player2.spr_piledriver)
	    {
	    ...
	    if (obj_player2.state == (48 << 0) && obj_player2.sprite_index == obj_player2.spr_swingding)
	    {
	        if (floor(obj_player2.image_index) == 0)
	        {
	            depth = -8
